...
pub use map::Map;
use mozjs::jsapi::{
	JS_NewGlobalObject, JSCLASS_RESERVED_SLOTS_MASK, JSCLASS_RESERVED_SLOTS_SHIFT, JSClass, JSPrincipals,
...
pub const unsafe fn class_num_reserved_slots(class: *const JSClass) -> u32 {
