...
use mozjs::jsapi::{
	BigIntFitsNumber, BigIntFromBool, BigIntFromInt64, BigIntFromUint64, BigIntIsInt64, BigIntIsNegative, BigIntIsUint64, BigIntToNumber,
	BigIntToString, NumberToBigInt, StringToBigInt1,
};
...
impl<'b> BigInt<'b> {
	...
	pub fn from_f64<'cx>(cx: &'cx Context, number: f64) -> Result<BigInt<'cx>, Exception> {
	...
	pub fn from_string<'cx>(cx: &'cx Context, string: &str) -> Result<BigInt<'cx>, Option<Exception>> {
